#
# xSqlCreateVirtualLogDisk: DSC resource to create a virtual data disk 
#
...
function Set-TargetResource
{
    ...
    Format-Volume -DriveLetter $DiskLetter -FileSystem NTFS -AllocationUnitSize  $InterleaveSizeInByte -NewFileSystemLabel $NewVolumeLabelName -Confirm:$false -Force
